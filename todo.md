...
## 스낵픽 섹션 카테고리 메뉴 디자인 개선 (Phase 10)

- [x] 카테고리 버튼 디자인 개선 (Pill 형태, 높이 52~60px)
- [x] 활성 카테고리: 진한 녹색(#006B4F) 배경 + 흰색 텍스트
- [x] 비활성 카테고리: 흰색 배경 + 연회색 테두리(#D9D9D9)
- [x] 호버 시 연녹색 배경 적용
- [x] 상품 카드 배경: 흰색 + border-radius 16px
- [x] 상품 이미지 영역: 흰색 배경 + 24px 여백
- [x] 이미지 object-fit: contain 적용
- [x] PC/모바일 반응형 적용 (PC: 4컬럼, 모바일: 2컬럼)
