...
## 카테고리 버튼 통합 디자인 - 원형 버튼 앱 런처 스타일 (Phase 12)

- [x] 모바일/PC 모두 원형 버튼(Circle Button)으로 통일
- [x] PC 버튼 크기: w-24 h-24 (96px)
- [x] 모바일 버튼 크기: aspect-square (반응형)
- [x] 아이콘 상단, 텍스트 하단 배치
- [x] 선택 상태: #006B4F 배경 + 흰색 텍스트
- [x] 비선택 상태: 흰색 배경 + 진회색 텍스트 + 부드러운 그림자
- [x] PC Hover: shadow-xl + scale-105 (Elevation 효과)
- [x] 모바일 Hover: shadow-md
- [x] 앱 런처 스타일 (Toss/Starbucks/Apple 참고)
- [x] 카드형 메뉴 느낌 제거
- [x] 네이티브 앱 경험 제공
