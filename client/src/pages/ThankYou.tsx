    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 to-primary/10 flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8 text-center">
        ...
        <div className="flex justify-center">
          <div className="w-20 h-20 bg-primary rounded-[10px] flex items-center justify-center animate-bounce">
        ...
        {/* Details */}
        <div className="bg-white rounded-[10px] p-8 border border-border space-y-4">
          <div className="space-y-2">
