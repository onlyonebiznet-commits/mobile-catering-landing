          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
            <label className="space-y-1">
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-slate-300 rounded-[10px] text-sm"
              />
            </label>
            <label className="space-y-1">
            ...
            <select
              ...
              className="px-4 py-2 border border-slate-300 rounded-[10px] text-sm"
            >
                    ...
                    {filteredConsultations.map((item) => (
                      <tr key={item.id} className="border-b border-slate-200 hover:bg-slate-50">
                        ...
                        <td className="py-3 px-4">
                          <span className={`px-2 py-1 rounded-[10px] border text-xs font-medium ${getWebhookStatusColor(item.webhookStatus)}`}>
                          ...
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <button
                                ...
                                className={`px-3 py-1 rounded-[10px] border font-medium text-xs cursor-pointer transition-colors hover:opacity-80 ${getStatusColor(item.status || 'pending')}`}
                              >
