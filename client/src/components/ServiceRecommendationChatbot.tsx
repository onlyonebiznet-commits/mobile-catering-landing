          ...
          <div className="p-6 max-h-96 overflow-y-auto">
            {submitted ? (
              <div className="text-center py-8">
                <div className="w-12 h-12 bg-status-success/10 rounded-[10px] flex items-center justify-center mx-auto mb-4">
                ...
                <div className="space-y-2">
                  {services.map((service) => (
                    <button
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-[10px] text-left hover:border-[#007651] hover:bg-[#007651]/5 transition-all duration-200 font-medium text-gray-700 hover:text-[#007651]"
                    >
                      {service}
                    </button>
                  ))}
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    <input
                      ...
                      required
                      className="px-3 py-2 border border-gray-300 rounded-[10px] text-sm focus:outline-none focus:border-[#007651]"
                    />
                    <input
                      type="text"
                      name="company"
                  ...
                  <textarea
                    ...
                    onChange={handleFormChange}
                    rows={3}
                    className="w-full px-3 py-2 border border-gray-300 rounded-[10px] text-sm focus:outline-none focus:border-[#007651] resize-none"
                  />
                    ...
                    >
                      <AccordionItem value="personal-info" className="border border-gray-200 rounded-[10px] px-3">
                        <div className="flex items-center justify-between py-2">
                          ...
                          <button
                            type="button"
                            className="flex-shrink-0 rounded-[10px] p-1 text-gray-500 hover:bg-gray-100 hover:text-gray-900"
                        ...
                        <AccordionContent className="rounded-[10px] bg-gray-50 p-3 text-xs leading-relaxed text-gray-600">
                      ...
                      <AccordionItem value="advertising" className="border border-gray-200 rounded-[10px] px-3">
                        <div className="flex items-center justify-between py-2">
                          <div className="flex items-center gap-2 min-w-0">
                            <Checkbox
                  ...
                  <div className="flex gap-2 pt-2">
                    <button
                      type="button"
                      onClick={handleBack}
                      className="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-[10px] hover:bg-gray-50 transition-colors duration-200 font-medium text-sm"
                    >
                      뒤로가기
                    </button>
                    <button
                      ...
                      className="flex-1 px-4 py-2 bg-[#007651] text-white rounded-[10px] hover:bg-[#008F69] transition-colors duration-200 font-medium text-sm"
                      onClick={() => {
